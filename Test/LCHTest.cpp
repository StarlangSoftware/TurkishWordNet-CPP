...
TEST_CASE("LCHTest-testComputeSimilarity") {
    ...
    REQUIRE_THAT(0.7802, Catch::Matchers::WithinAbs(lch.computeSimilarity(*turkish.getSynSetWithId("TUR10-0412120"), *turkish.getSynSetWithId("TUR10-0755370")), 0.0001));
