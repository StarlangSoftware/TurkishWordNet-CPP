...
TEST_CASE("WuPalmerTest-testComputeSimilarity") {
    ...
    REQUIRE_THAT(0.2857, Catch::Matchers::WithinAbs(wuPalmer.computeSimilarity(*turkish.getSynSetWithId("TUR10-0412120"), *turkish.getSynSetWithId("TUR10-0755370")), 0.0001));
