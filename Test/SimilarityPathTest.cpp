...
TEST_CASE("SimilarityPathTest-testComputeSimilarity") {
    ...
    REQUIRE_THAT(15.0, Catch::Matchers::WithinAbs(similarityPath.computeSimilarity(*turkish.getSynSetWithId("TUR10-0412120"), *turkish.getSynSetWithId("TUR10-0755370")), 0.0001));
