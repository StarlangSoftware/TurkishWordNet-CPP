...
public:
    ...
    vector<Literal> constructLiterals(const string& word, const MorphologicalParse& parse, const MetamorphicParse& metaParse, const FsmMorphologicalAnalyzer &fsm) const;
    ...
    vector<Literal> constructIdiomLiterals(const MorphologicalParse& morphologicalParse1, const MorphologicalParse& morphologicalParse2, const MetamorphicParse& metaParse1, const MetamorphicParse& metaParse2, const FsmMorphologicalAnalyzer &fsm) const;
